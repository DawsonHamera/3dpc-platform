...
import z from "zod";
import {
    recycling_logCreateInputObjectSchema,
    recycling_logModelSchema,
} from "../../types/zod/schemas";

export type RecyclingLog = z.infer<typeof recycling_logModelSchema>;
export type CreateRecyclingLog = z.infer<
    typeof recycling_logCreateInputObjectSchema
>;

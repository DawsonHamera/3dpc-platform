...
export const modelsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.modelsSelect> = z.object({
...
export const modelsFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    image_file_id: z.boolean().optional(),
    model_file_id: z.boolean().optional(),
...
export const modelsFindFirstOrThrowSchema: z.ZodType<Prisma.modelsFindFirstOrThrowArgs> = z.object({ select: modelsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => modelsIncludeObjectSchema.optional()), orderBy: z.union([modelsOrderByWithRelationInputObjectSchema, modelsOrderByWithRelationInputObjectSchema.array()]).optional(), where: modelsWhereInputObjectSchema.optional(), cursor: modelsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ModelsScalarFieldEnumSchema, ModelsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.modelsFindFirstOrThrowArgs>;

export const modelsFindFirstOrThrowZodSchema = z.object({ select: modelsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => modelsIncludeObjectSchema.optional()), orderBy: z.union([modelsOrderByWithRelationInputObjectSchema, modelsOrderByWithRelationInputObjectSchema.array()]).optional(), where: modelsWhereInputObjectSchema.optional(), cursor: modelsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ModelsScalarFieldEnumSchema, ModelsScalarFieldEnumSchema.array()]).optional() }).strict();
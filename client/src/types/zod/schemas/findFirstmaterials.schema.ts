...
export const materialsFindFirstSelectSchema: z.ZodType<Prisma.materialsSelect> = z.object({
...
export const materialsFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    hex: z.boolean().optional(),
    texture_file_id: z.boolean().optional(),
...
export const materialsFindFirstSchema: z.ZodType<Prisma.materialsFindFirstArgs> = z.object({ select: materialsFindFirstSelectSchema.optional(), include: z.lazy(() => materialsIncludeObjectSchema.optional()), orderBy: z.union([materialsOrderByWithRelationInputObjectSchema, materialsOrderByWithRelationInputObjectSchema.array()]).optional(), where: materialsWhereInputObjectSchema.optional(), cursor: materialsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MaterialsScalarFieldEnumSchema, MaterialsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.materialsFindFirstArgs>;

export const materialsFindFirstZodSchema = z.object({ select: materialsFindFirstSelectSchema.optional(), include: z.lazy(() => materialsIncludeObjectSchema.optional()), orderBy: z.union([materialsOrderByWithRelationInputObjectSchema, materialsOrderByWithRelationInputObjectSchema.array()]).optional(), where: materialsWhereInputObjectSchema.optional(), cursor: materialsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MaterialsScalarFieldEnumSchema, MaterialsScalarFieldEnumSchema.array()]).optional() }).strict();
...
export const task_statusesFindFirstOrThrowSelectSchema: z.ZodType<Prisma.task_statusesSelect> = z.object({
...
export const task_statusesFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    created_at: z.boolean().optional(),
...
export const task_statusesFindFirstOrThrowSchema: z.ZodType<Prisma.task_statusesFindFirstOrThrowArgs> = z.object({ select: task_statusesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => task_statusesIncludeObjectSchema.optional()), orderBy: z.union([task_statusesOrderByWithRelationInputObjectSchema, task_statusesOrderByWithRelationInputObjectSchema.array()]).optional(), where: task_statusesWhereInputObjectSchema.optional(), cursor: task_statusesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskStatusesScalarFieldEnumSchema, TaskStatusesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.task_statusesFindFirstOrThrowArgs>;

export const task_statusesFindFirstOrThrowZodSchema = z.object({ select: task_statusesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => task_statusesIncludeObjectSchema.optional()), orderBy: z.union([task_statusesOrderByWithRelationInputObjectSchema, task_statusesOrderByWithRelationInputObjectSchema.array()]).optional(), where: task_statusesWhereInputObjectSchema.optional(), cursor: task_statusesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskStatusesScalarFieldEnumSchema, TaskStatusesScalarFieldEnumSchema.array()]).optional() }).strict();
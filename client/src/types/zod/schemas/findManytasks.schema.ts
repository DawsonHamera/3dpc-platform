...
export const tasksFindManySelectSchema: z.ZodType<Prisma.tasksSelect> = z.object({
...
export const tasksFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    request_id: z.boolean().optional(),
    model_id: z.boolean().optional(),
    printer_id: z.boolean().optional(),
...
export const tasksFindManySchema: z.ZodType<Prisma.tasksFindManyArgs> = z.object({ select: tasksFindManySelectSchema.optional(), include: z.lazy(() => tasksIncludeObjectSchema.optional()), orderBy: z.union([tasksOrderByWithRelationInputObjectSchema, tasksOrderByWithRelationInputObjectSchema.array()]).optional(), where: tasksWhereInputObjectSchema.optional(), cursor: tasksWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TasksScalarFieldEnumSchema, TasksScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tasksFindManyArgs>;

export const tasksFindManyZodSchema = z.object({ select: tasksFindManySelectSchema.optional(), include: z.lazy(() => tasksIncludeObjectSchema.optional()), orderBy: z.union([tasksOrderByWithRelationInputObjectSchema, tasksOrderByWithRelationInputObjectSchema.array()]).optional(), where: tasksWhereInputObjectSchema.optional(), cursor: tasksWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TasksScalarFieldEnumSchema, TasksScalarFieldEnumSchema.array()]).optional() }).strict();
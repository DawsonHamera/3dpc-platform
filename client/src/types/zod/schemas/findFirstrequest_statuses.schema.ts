...
export const request_statusesFindFirstSelectSchema: z.ZodType<Prisma.request_statusesSelect> = z.object({
...
export const request_statusesFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    created_at: z.boolean().optional(),
...
export const request_statusesFindFirstSchema: z.ZodType<Prisma.request_statusesFindFirstArgs> = z.object({ select: request_statusesFindFirstSelectSchema.optional(), include: z.lazy(() => request_statusesIncludeObjectSchema.optional()), orderBy: z.union([request_statusesOrderByWithRelationInputObjectSchema, request_statusesOrderByWithRelationInputObjectSchema.array()]).optional(), where: request_statusesWhereInputObjectSchema.optional(), cursor: request_statusesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RequestStatusesScalarFieldEnumSchema, RequestStatusesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.request_statusesFindFirstArgs>;

export const request_statusesFindFirstZodSchema = z.object({ select: request_statusesFindFirstSelectSchema.optional(), include: z.lazy(() => request_statusesIncludeObjectSchema.optional()), orderBy: z.union([request_statusesOrderByWithRelationInputObjectSchema, request_statusesOrderByWithRelationInputObjectSchema.array()]).optional(), where: request_statusesWhereInputObjectSchema.optional(), cursor: request_statusesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RequestStatusesScalarFieldEnumSchema, RequestStatusesScalarFieldEnumSchema.array()]).optional() }).strict();
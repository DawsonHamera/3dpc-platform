...
export const attendancesFindFirstSelectSchema: z.ZodType<Prisma.attendancesSelect> = z.object({
...
export const attendancesFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    event_id: z.boolean().optional(),
    created_at: z.boolean().optional(),
...
export const attendancesFindFirstSchema: z.ZodType<Prisma.attendancesFindFirstArgs> = z.object({ select: attendancesFindFirstSelectSchema.optional(), include: z.lazy(() => attendancesIncludeObjectSchema.optional()), orderBy: z.union([attendancesOrderByWithRelationInputObjectSchema, attendancesOrderByWithRelationInputObjectSchema.array()]).optional(), where: attendancesWhereInputObjectSchema.optional(), cursor: attendancesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AttendancesScalarFieldEnumSchema, AttendancesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.attendancesFindFirstArgs>;

export const attendancesFindFirstZodSchema = z.object({ select: attendancesFindFirstSelectSchema.optional(), include: z.lazy(() => attendancesIncludeObjectSchema.optional()), orderBy: z.union([attendancesOrderByWithRelationInputObjectSchema, attendancesOrderByWithRelationInputObjectSchema.array()]).optional(), where: attendancesWhereInputObjectSchema.optional(), cursor: attendancesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AttendancesScalarFieldEnumSchema, AttendancesScalarFieldEnumSchema.array()]).optional() }).strict();
...
export const rolesFindFirstSelectSchema: z.ZodType<Prisma.rolesSelect> = z.object({
...
export const rolesFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    created_at: z.boolean().optional(),

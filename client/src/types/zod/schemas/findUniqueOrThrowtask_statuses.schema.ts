...
export const task_statusesFindUniqueOrThrowSchema: z.ZodType<Prisma.task_statusesFindUniqueOrThrowArgs> = z.object({ select: task_statusesSelectObjectSchema.optional(), include: task_statusesIncludeObjectSchema.optional(), where: task_statusesWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.task_statusesFindUniqueOrThrowArgs>;

export const task_statusesFindUniqueOrThrowZodSchema = z.object({ select: task_statusesSelectObjectSchema.optional(), include: task_statusesIncludeObjectSchema.optional(), where: task_statusesWhereUniqueInputObjectSchema }).strict();
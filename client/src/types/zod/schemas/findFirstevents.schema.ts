...
export const eventsFindFirstSelectSchema: z.ZodType<Prisma.eventsSelect> = z.object({
...
export const eventsFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    title: z.boolean().optional(),
    description: z.boolean().optional(),
    location: z.boolean().optional(),
...
export const eventsFindFirstSchema: z.ZodType<Prisma.eventsFindFirstArgs> = z.object({ select: eventsFindFirstSelectSchema.optional(), include: z.lazy(() => eventsIncludeObjectSchema.optional()), orderBy: z.union([eventsOrderByWithRelationInputObjectSchema, eventsOrderByWithRelationInputObjectSchema.array()]).optional(), where: eventsWhereInputObjectSchema.optional(), cursor: eventsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EventsScalarFieldEnumSchema, EventsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.eventsFindFirstArgs>;

export const eventsFindFirstZodSchema = z.object({ select: eventsFindFirstSelectSchema.optional(), include: z.lazy(() => eventsIncludeObjectSchema.optional()), orderBy: z.union([eventsOrderByWithRelationInputObjectSchema, eventsOrderByWithRelationInputObjectSchema.array()]).optional(), where: eventsWhereInputObjectSchema.optional(), cursor: eventsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EventsScalarFieldEnumSchema, EventsScalarFieldEnumSchema.array()]).optional() }).strict();
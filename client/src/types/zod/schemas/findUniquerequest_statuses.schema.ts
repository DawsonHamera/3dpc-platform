...
export const request_statusesFindUniqueSchema: z.ZodType<Prisma.request_statusesFindUniqueArgs> = z.object({ select: request_statusesSelectObjectSchema.optional(), include: request_statusesIncludeObjectSchema.optional(), where: request_statusesWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.request_statusesFindUniqueArgs>;

export const request_statusesFindUniqueZodSchema = z.object({ select: request_statusesSelectObjectSchema.optional(), include: request_statusesIncludeObjectSchema.optional(), where: request_statusesWhereUniqueInputObjectSchema }).strict();
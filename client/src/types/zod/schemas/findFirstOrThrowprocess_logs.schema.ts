...
export const process_logsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.process_logsSelect> = z.object({
...
export const process_logsFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    process_instance_id: z.boolean().optional(),
    step_order: z.boolean().optional(),
    level: z.boolean().optional(),
...
export const process_logsFindFirstOrThrowSchema: z.ZodType<Prisma.process_logsFindFirstOrThrowArgs> = z.object({ select: process_logsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => process_logsIncludeObjectSchema.optional()), orderBy: z.union([process_logsOrderByWithRelationInputObjectSchema, process_logsOrderByWithRelationInputObjectSchema.array()]).optional(), where: process_logsWhereInputObjectSchema.optional(), cursor: process_logsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProcessLogsScalarFieldEnumSchema, ProcessLogsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.process_logsFindFirstOrThrowArgs>;

export const process_logsFindFirstOrThrowZodSchema = z.object({ select: process_logsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => process_logsIncludeObjectSchema.optional()), orderBy: z.union([process_logsOrderByWithRelationInputObjectSchema, process_logsOrderByWithRelationInputObjectSchema.array()]).optional(), where: process_logsWhereInputObjectSchema.optional(), cursor: process_logsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProcessLogsScalarFieldEnumSchema, ProcessLogsScalarFieldEnumSchema.array()]).optional() }).strict();
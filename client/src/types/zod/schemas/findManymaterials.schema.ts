...
export const materialsFindManySelectSchema: z.ZodType<Prisma.materialsSelect> = z.object({
...
export const materialsFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    hex: z.boolean().optional(),
    texture_file_id: z.boolean().optional(),
...
export const materialsFindManySchema: z.ZodType<Prisma.materialsFindManyArgs> = z.object({ select: materialsFindManySelectSchema.optional(), include: z.lazy(() => materialsIncludeObjectSchema.optional()), orderBy: z.union([materialsOrderByWithRelationInputObjectSchema, materialsOrderByWithRelationInputObjectSchema.array()]).optional(), where: materialsWhereInputObjectSchema.optional(), cursor: materialsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MaterialsScalarFieldEnumSchema, MaterialsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.materialsFindManyArgs>;

export const materialsFindManyZodSchema = z.object({ select: materialsFindManySelectSchema.optional(), include: z.lazy(() => materialsIncludeObjectSchema.optional()), orderBy: z.union([materialsOrderByWithRelationInputObjectSchema, materialsOrderByWithRelationInputObjectSchema.array()]).optional(), where: materialsWhereInputObjectSchema.optional(), cursor: materialsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MaterialsScalarFieldEnumSchema, MaterialsScalarFieldEnumSchema.array()]).optional() }).strict();
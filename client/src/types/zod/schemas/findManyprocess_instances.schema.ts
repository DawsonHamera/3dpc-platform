...
export const process_instancesFindManySelectSchema: z.ZodType<Prisma.process_instancesSelect> = z.object({
...
export const process_instancesFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    process_template_id: z.boolean().optional(),

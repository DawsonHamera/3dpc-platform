...
export const Process_instance_stepsMaxAggregateInputObjectSchema: z.ZodType<Prisma.Process_instance_stepsMaxAggregateInputType> = makeSchema() as unknown as z.ZodType<Prisma.Process_instance_stepsMaxAggregateInputType>;
export const Process_instance_stepsMaxAggregateInputObjectZodSchema = makeSchema();

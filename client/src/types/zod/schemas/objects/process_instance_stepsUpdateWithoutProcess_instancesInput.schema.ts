...
import { stepsUpdateOneRequiredWithoutProcess_instance_stepsNestedInputObjectSchema as stepsUpdateOneRequiredWithoutProcess_instance_stepsNestedInputObjectSchema } from './stepsUpdateOneRequiredWithoutProcess_instance_stepsNestedInput.schema';
...
const makeSchema = () => z.object({
  ...
  steps: z.lazy(() => stepsUpdateOneRequiredWithoutProcess_instance_stepsNestedInputObjectSchema).optional(),
  users: z.lazy(() => usersUpdateOneWithoutProcess_instance_stepsNestedInputObjectSchema).optional()
}).strict();
export const process_instance_stepsUpdateWithoutProcess_instancesInputObjectSchema: z.ZodType<Prisma.process_instance_stepsUpdateWithoutProcess_instancesInput> = makeSchema() as unknown as z.ZodType<Prisma.process_instance_stepsUpdateWithoutProcess_instancesInput>;
export const process_instance_stepsUpdateWithoutProcess_instancesInputObjectZodSchema = makeSchema();

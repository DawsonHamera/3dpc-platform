...
const makeSchema = () => z.object({
  update: z.union([z.lazy(() => filesUpdateWithoutMaterials_materials_image_file_idTofilesInputObjectSchema), z.lazy(() => filesUncheckedUpdateWithoutMaterials_materials_image_file_idTofilesInputObjectSchema)]),
...
export const filesUpsertWithoutMaterials_materials_image_file_idTofilesInputObjectSchema: z.ZodType<Prisma.filesUpsertWithoutMaterials_materials_image_file_idTofilesInput> = makeSchema() as unknown as z.ZodType<Prisma.filesUpsertWithoutMaterials_materials_image_file_idTofilesInput>;
export const filesUpsertWithoutMaterials_materials_image_file_idTofilesInputObjectZodSchema = makeSchema();

...
export const tasksUncheckedCreateNestedManyWithoutRequestsInputObjectSchema: z.ZodType<Prisma.tasksUncheckedCreateNestedManyWithoutRequestsInput> = makeSchema() as unknown as z.ZodType<Prisma.tasksUncheckedCreateNestedManyWithoutRequestsInput>;
export const tasksUncheckedCreateNestedManyWithoutRequestsInputObjectZodSchema = makeSchema();

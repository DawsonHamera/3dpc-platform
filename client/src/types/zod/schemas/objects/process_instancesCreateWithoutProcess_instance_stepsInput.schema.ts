...
const makeSchema = () => z.object({
  ...
  process_logs: z.lazy(() => process_logsCreateNestedManyWithoutProcess_instancesInputObjectSchema).optional(),
  tasks: z.lazy(() => tasksCreateNestedManyWithoutProcess_instancesInputObjectSchema).optional()
}).strict();
export const process_instancesCreateWithoutProcess_instance_stepsInputObjectSchema: z.ZodType<Prisma.process_instancesCreateWithoutProcess_instance_stepsInput> = makeSchema() as unknown as z.ZodType<Prisma.process_instancesCreateWithoutProcess_instance_stepsInput>;
export const process_instancesCreateWithoutProcess_instance_stepsInputObjectZodSchema = makeSchema();

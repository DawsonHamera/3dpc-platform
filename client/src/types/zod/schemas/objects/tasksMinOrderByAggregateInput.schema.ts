...
export const tasksMinOrderByAggregateInputObjectSchema: z.ZodType<Prisma.tasksMinOrderByAggregateInput> = makeSchema() as unknown as z.ZodType<Prisma.tasksMinOrderByAggregateInput>;
export const tasksMinOrderByAggregateInputObjectZodSchema = makeSchema();

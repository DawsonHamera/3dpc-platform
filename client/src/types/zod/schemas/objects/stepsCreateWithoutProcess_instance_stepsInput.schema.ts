...
const makeSchema = () => z.object({
  ...
  error_reports: z.lazy(() => error_reportsCreateNestedManyWithoutStepsInputObjectSchema).optional(),
  process_template_steps: z.lazy(() => process_template_stepsCreateNestedManyWithoutStepsInputObjectSchema).optional(),
  step_actions: z.lazy(() => step_actionsCreateNestedManyWithoutStepsInputObjectSchema).optional(),
  step_content: z.lazy(() => step_contentCreateNestedManyWithoutStepsInputObjectSchema).optional()
}).strict();
export const stepsCreateWithoutProcess_instance_stepsInputObjectSchema: z.ZodType<Prisma.stepsCreateWithoutProcess_instance_stepsInput> = makeSchema() as unknown as z.ZodType<Prisma.stepsCreateWithoutProcess_instance_stepsInput>;
export const stepsCreateWithoutProcess_instance_stepsInputObjectZodSchema = makeSchema();

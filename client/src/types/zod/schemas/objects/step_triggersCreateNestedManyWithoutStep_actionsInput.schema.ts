...
export const step_triggersCreateNestedManyWithoutStep_actionsInputObjectSchema: z.ZodType<Prisma.step_triggersCreateNestedManyWithoutStep_actionsInput> = makeSchema() as unknown as z.ZodType<Prisma.step_triggersCreateNestedManyWithoutStep_actionsInput>;
export const step_triggersCreateNestedManyWithoutStep_actionsInputObjectZodSchema = makeSchema();

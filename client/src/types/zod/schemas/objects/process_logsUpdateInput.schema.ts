...
import { process_instancesUpdateOneRequiredWithoutProcess_logsNestedInputObjectSchema as process_instancesUpdateOneRequiredWithoutProcess_logsNestedInputObjectSchema } from './process_instancesUpdateOneRequiredWithoutProcess_logsNestedInput.schema';
import { usersUpdateOneWithoutProcess_logsNestedInputObjectSchema as usersUpdateOneWithoutProcess_logsNestedInputObjectSchema } from './usersUpdateOneWithoutProcess_logsNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  process_instances: z.lazy(() => process_instancesUpdateOneRequiredWithoutProcess_logsNestedInputObjectSchema).optional(),
  users: z.lazy(() => usersUpdateOneWithoutProcess_logsNestedInputObjectSchema).optional()
}).strict();
export const process_logsUpdateInputObjectSchema: z.ZodType<Prisma.process_logsUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.process_logsUpdateInput>;
export const process_logsUpdateInputObjectZodSchema = makeSchema();

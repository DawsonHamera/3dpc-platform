...
export const requestsCreateNestedManyWithoutRequest_statusesInputObjectSchema: z.ZodType<Prisma.requestsCreateNestedManyWithoutRequest_statusesInput> = makeSchema() as unknown as z.ZodType<Prisma.requestsCreateNestedManyWithoutRequest_statusesInput>;
export const requestsCreateNestedManyWithoutRequest_statusesInputObjectZodSchema = makeSchema();

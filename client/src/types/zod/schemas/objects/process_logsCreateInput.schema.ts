...
export const process_logsCreateInputObjectSchema: z.ZodType<Prisma.process_logsCreateInput> = makeSchema() as unknown as z.ZodType<Prisma.process_logsCreateInput>;
export const process_logsCreateInputObjectZodSchema = makeSchema();

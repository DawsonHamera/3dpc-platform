...
const makeSchema = () => z.object({
  ...
  update: z.union([z.lazy(() => materialsUpdateWithoutFiles_materials_image_file_idTofilesInputObjectSchema), z.lazy(() => materialsUncheckedUpdateWithoutFiles_materials_image_file_idTofilesInputObjectSchema)]),
  create: z.union([z.lazy(() => materialsCreateWithoutFiles_materials_image_file_idTofilesInputObjectSchema), z.lazy(() => materialsUncheckedCreateWithoutFiles_materials_image_file_idTofilesInputObjectSchema)])
}).strict();
export const materialsUpsertWithWhereUniqueWithoutFiles_materials_image_file_idTofilesInputObjectSchema: z.ZodType<Prisma.materialsUpsertWithWhereUniqueWithoutFiles_materials_image_file_idTofilesInput> = makeSchema() as unknown as z.ZodType<Prisma.materialsUpsertWithWhereUniqueWithoutFiles_materials_image_file_idTofilesInput>;
export const materialsUpsertWithWhereUniqueWithoutFiles_materials_image_file_idTofilesInputObjectZodSchema = makeSchema();

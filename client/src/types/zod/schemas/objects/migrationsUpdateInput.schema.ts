...
export const migrationsUpdateInputObjectSchema: z.ZodType<Prisma.migrationsUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.migrationsUpdateInput>;
export const migrationsUpdateInputObjectZodSchema = makeSchema();

...
export const materialsMaxOrderByAggregateInputObjectSchema: z.ZodType<Prisma.materialsMaxOrderByAggregateInput> = makeSchema() as unknown as z.ZodType<Prisma.materialsMaxOrderByAggregateInput>;
export const materialsMaxOrderByAggregateInputObjectZodSchema = makeSchema();

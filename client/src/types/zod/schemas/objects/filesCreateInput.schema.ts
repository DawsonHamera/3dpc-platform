...
const makeSchema = () => z.object({
  ...
  events: z.lazy(() => eventsCreateNestedManyWithoutFilesInputObjectSchema),
  uploader: z.lazy(() => usersCreateNestedOneWithoutFilesInputObjectSchema).optional(),
  materials_materials_image_file_idTofiles: z.lazy(() => materialsCreateNestedManyWithoutFiles_materials_image_file_idTofilesInputObjectSchema),
  materials_materials_texture_file_idTofiles: z.lazy(() => materialsCreateNestedManyWithoutFiles_materials_texture_file_idTofilesInputObjectSchema),
  printers: z.lazy(() => printersCreateNestedManyWithoutFilesInputObjectSchema)
}).strict();
export const filesCreateInputObjectSchema: z.ZodType<Prisma.filesCreateInput> = makeSchema() as unknown as z.ZodType<Prisma.filesCreateInput>;
export const filesCreateInputObjectZodSchema = makeSchema();

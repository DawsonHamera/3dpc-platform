...
export const process_logsUncheckedCreateNestedManyWithoutUsersInputObjectSchema: z.ZodType<Prisma.process_logsUncheckedCreateNestedManyWithoutUsersInput> = makeSchema() as unknown as z.ZodType<Prisma.process_logsUncheckedCreateNestedManyWithoutUsersInput>;
export const process_logsUncheckedCreateNestedManyWithoutUsersInputObjectZodSchema = makeSchema();

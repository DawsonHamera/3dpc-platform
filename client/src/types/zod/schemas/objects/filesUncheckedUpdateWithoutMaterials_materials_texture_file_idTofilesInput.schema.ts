...
import { materialsUncheckedUpdateManyWithoutFiles_materials_image_file_idTofilesNestedInputObjectSchema as materialsUncheckedUpdateManyWithoutFiles_materials_image_file_idTofilesNestedInputObjectSchema } from './materialsUncheckedUpdateManyWithoutFiles_materials_image_file_idTofilesNestedInput.schema';
...
const makeSchema = () => z.object({
  ...
  materials_materials_image_file_idTofiles: z.lazy(() => materialsUncheckedUpdateManyWithoutFiles_materials_image_file_idTofilesNestedInputObjectSchema).optional(),
  printers: z.lazy(() => printersUncheckedUpdateManyWithoutFilesNestedInputObjectSchema).optional()
}).strict();
export const filesUncheckedUpdateWithoutMaterials_materials_texture_file_idTofilesInputObjectSchema: z.ZodType<Prisma.filesUncheckedUpdateWithoutMaterials_materials_texture_file_idTofilesInput> = makeSchema() as unknown as z.ZodType<Prisma.filesUncheckedUpdateWithoutMaterials_materials_texture_file_idTofilesInput>;
export const filesUncheckedUpdateWithoutMaterials_materials_texture_file_idTofilesInputObjectZodSchema = makeSchema();

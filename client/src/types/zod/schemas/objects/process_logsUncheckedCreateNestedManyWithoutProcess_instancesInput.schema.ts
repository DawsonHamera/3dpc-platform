...
export const process_logsUncheckedCreateNestedManyWithoutProcess_instancesInputObjectSchema: z.ZodType<Prisma.process_logsUncheckedCreateNestedManyWithoutProcess_instancesInput> = makeSchema() as unknown as z.ZodType<Prisma.process_logsUncheckedCreateNestedManyWithoutProcess_instancesInput>;
export const process_logsUncheckedCreateNestedManyWithoutProcess_instancesInputObjectZodSchema = makeSchema();

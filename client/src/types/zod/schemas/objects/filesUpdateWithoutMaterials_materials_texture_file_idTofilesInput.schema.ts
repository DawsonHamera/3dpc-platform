...
import { materialsUpdateManyWithoutFiles_materials_image_file_idTofilesNestedInputObjectSchema as materialsUpdateManyWithoutFiles_materials_image_file_idTofilesNestedInputObjectSchema } from './materialsUpdateManyWithoutFiles_materials_image_file_idTofilesNestedInput.schema';
...
const makeSchema = () => z.object({
  ...
  materials_materials_image_file_idTofiles: z.lazy(() => materialsUpdateManyWithoutFiles_materials_image_file_idTofilesNestedInputObjectSchema).optional(),
  printers: z.lazy(() => printersUpdateManyWithoutFilesNestedInputObjectSchema).optional()
}).strict();
export const filesUpdateWithoutMaterials_materials_texture_file_idTofilesInputObjectSchema: z.ZodType<Prisma.filesUpdateWithoutMaterials_materials_texture_file_idTofilesInput> = makeSchema() as unknown as z.ZodType<Prisma.filesUpdateWithoutMaterials_materials_texture_file_idTofilesInput>;
export const filesUpdateWithoutMaterials_materials_texture_file_idTofilesInputObjectZodSchema = makeSchema();

...
import { step_actionsUpdateOneRequiredWithoutStep_triggersNestedInputObjectSchema as step_actionsUpdateOneRequiredWithoutStep_triggersNestedInputObjectSchema } from './step_actionsUpdateOneRequiredWithoutStep_triggersNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  step_actions: z.lazy(() => step_actionsUpdateOneRequiredWithoutStep_triggersNestedInputObjectSchema).optional()
}).strict();
export const step_triggersUpdateInputObjectSchema: z.ZodType<Prisma.step_triggersUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.step_triggersUpdateInput>;
export const step_triggersUpdateInputObjectZodSchema = makeSchema();

...
const makeSchema = () => z.object({
  ...
  data: z.union([z.lazy(() => materialsUpdateWithoutFiles_materials_texture_file_idTofilesInputObjectSchema), z.lazy(() => materialsUncheckedUpdateWithoutFiles_materials_texture_file_idTofilesInputObjectSchema)])
}).strict();
export const materialsUpdateWithWhereUniqueWithoutFiles_materials_texture_file_idTofilesInputObjectSchema: z.ZodType<Prisma.materialsUpdateWithWhereUniqueWithoutFiles_materials_texture_file_idTofilesInput> = makeSchema() as unknown as z.ZodType<Prisma.materialsUpdateWithWhereUniqueWithoutFiles_materials_texture_file_idTofilesInput>;
export const materialsUpdateWithWhereUniqueWithoutFiles_materials_texture_file_idTofilesInputObjectZodSchema = makeSchema();

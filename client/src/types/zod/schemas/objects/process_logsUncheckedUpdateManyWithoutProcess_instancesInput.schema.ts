...
const makeSchema = () => z.object({
  ...
  user_id: z.union([z.number().int(), z.lazy(() => NullableIntFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  created_at: z.union([z.coerce.date(), z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(),
  deleted_at: z.union([z.coerce.date(), z.lazy(() => NullableDateTimeFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  updated_at: z.union([z.coerce.date(), z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional()
}).strict();
export const process_logsUncheckedUpdateManyWithoutProcess_instancesInputObjectSchema: z.ZodType<Prisma.process_logsUncheckedUpdateManyWithoutProcess_instancesInput> = makeSchema() as unknown as z.ZodType<Prisma.process_logsUncheckedUpdateManyWithoutProcess_instancesInput>;
export const process_logsUncheckedUpdateManyWithoutProcess_instancesInputObjectZodSchema = makeSchema();

...
export const tasksCreateManyModelsInputObjectSchema: z.ZodType<Prisma.tasksCreateManyModelsInput> = makeSchema() as unknown as z.ZodType<Prisma.tasksCreateManyModelsInput>;
export const tasksCreateManyModelsInputObjectZodSchema = makeSchema();

...
export const process_logsUncheckedCreateInputObjectSchema: z.ZodType<Prisma.process_logsUncheckedCreateInput> = makeSchema() as unknown as z.ZodType<Prisma.process_logsUncheckedCreateInput>;
export const process_logsUncheckedCreateInputObjectZodSchema = makeSchema();

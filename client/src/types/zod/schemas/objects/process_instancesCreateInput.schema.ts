...
import { process_logsCreateNestedManyWithoutProcess_instancesInputObjectSchema as process_logsCreateNestedManyWithoutProcess_instancesInputObjectSchema } from './process_logsCreateNestedManyWithoutProcess_instancesInput.schema';
...
const makeSchema = () => z.object({
  ...
  process_instance_steps: z.lazy(() => process_instance_stepsCreateNestedManyWithoutProcess_instancesInputObjectSchema),
  ...
  process_logs: z.lazy(() => process_logsCreateNestedManyWithoutProcess_instancesInputObjectSchema),
  tasks: z.lazy(() => tasksCreateNestedManyWithoutProcess_instancesInputObjectSchema)
}).strict();
export const process_instancesCreateInputObjectSchema: z.ZodType<Prisma.process_instancesCreateInput> = makeSchema() as unknown as z.ZodType<Prisma.process_instancesCreateInput>;
export const process_instancesCreateInputObjectZodSchema = makeSchema();

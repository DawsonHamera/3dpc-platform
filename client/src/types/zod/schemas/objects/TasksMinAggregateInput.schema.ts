...
export const TasksMinAggregateInputObjectSchema: z.ZodType<Prisma.TasksMinAggregateInputType> = makeSchema() as unknown as z.ZodType<Prisma.TasksMinAggregateInputType>;
export const TasksMinAggregateInputObjectZodSchema = makeSchema();

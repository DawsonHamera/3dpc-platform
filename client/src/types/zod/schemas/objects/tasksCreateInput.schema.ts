...
const makeSchema = () => z.object({
  ...
  error_reports: z.lazy(() => error_reportsCreateNestedManyWithoutTasksInputObjectSchema),
...
export const tasksCreateInputObjectSchema: z.ZodType<Prisma.tasksCreateInput> = makeSchema() as unknown as z.ZodType<Prisma.tasksCreateInput>;
export const tasksCreateInputObjectZodSchema = makeSchema();

...
import { tasksUpdateManyWithoutRequestsNestedInputObjectSchema as tasksUpdateManyWithoutRequestsNestedInputObjectSchema } from './tasksUpdateManyWithoutRequestsNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  tasks: z.lazy(() => tasksUpdateManyWithoutRequestsNestedInputObjectSchema).optional()
}).strict();
export const requestsUpdateWithoutRequest_statusesInputObjectSchema: z.ZodType<Prisma.requestsUpdateWithoutRequest_statusesInput> = makeSchema() as unknown as z.ZodType<Prisma.requestsUpdateWithoutRequest_statusesInput>;
export const requestsUpdateWithoutRequest_statusesInputObjectZodSchema = makeSchema();

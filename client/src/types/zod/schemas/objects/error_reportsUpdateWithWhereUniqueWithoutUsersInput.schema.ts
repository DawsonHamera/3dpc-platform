...
const makeSchema = () => z.object({
  ...
  data: z.union([z.lazy(() => error_reportsUpdateWithoutUsersInputObjectSchema), z.lazy(() => error_reportsUncheckedUpdateWithoutUsersInputObjectSchema)])
}).strict();
export const error_reportsUpdateWithWhereUniqueWithoutUsersInputObjectSchema: z.ZodType<Prisma.error_reportsUpdateWithWhereUniqueWithoutUsersInput> = makeSchema() as unknown as z.ZodType<Prisma.error_reportsUpdateWithWhereUniqueWithoutUsersInput>;
export const error_reportsUpdateWithWhereUniqueWithoutUsersInputObjectZodSchema = makeSchema();

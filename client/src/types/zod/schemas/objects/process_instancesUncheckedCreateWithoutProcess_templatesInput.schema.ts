...
const makeSchema = () => z.object({
  ...
  process_instance_steps: z.lazy(() => process_instance_stepsUncheckedCreateNestedManyWithoutProcess_instancesInputObjectSchema).optional(),
  process_logs: z.lazy(() => process_logsUncheckedCreateNestedManyWithoutProcess_instancesInputObjectSchema).optional(),
  tasks: z.lazy(() => tasksUncheckedCreateNestedManyWithoutProcess_instancesInputObjectSchema).optional()
}).strict();
export const process_instancesUncheckedCreateWithoutProcess_templatesInputObjectSchema: z.ZodType<Prisma.process_instancesUncheckedCreateWithoutProcess_templatesInput> = makeSchema() as unknown as z.ZodType<Prisma.process_instancesUncheckedCreateWithoutProcess_templatesInput>;
export const process_instancesUncheckedCreateWithoutProcess_templatesInputObjectZodSchema = makeSchema();

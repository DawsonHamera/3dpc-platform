...
const process_logswhereinputSchema = z.object({
  AND: z.union([z.lazy(() => process_logsWhereInputObjectSchema), z.lazy(() => process_logsWhereInputObjectSchema).array()]).optional(),
  OR: z.lazy(() => process_logsWhereInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => process_logsWhereInputObjectSchema), z.lazy(() => process_logsWhereInputObjectSchema).array()]).optional(),
...
export const process_logsWhereInputObjectSchema: z.ZodType<Prisma.process_logsWhereInput> = process_logswhereinputSchema as unknown as z.ZodType<Prisma.process_logsWhereInput>;
export const process_logsWhereInputObjectZodSchema = process_logswhereinputSchema;

...
import { process_logsUpsertWithWhereUniqueWithoutUsersInputObjectSchema as process_logsUpsertWithWhereUniqueWithoutUsersInputObjectSchema } from './process_logsUpsertWithWhereUniqueWithoutUsersInput.schema';
...
import { process_logsUpdateWithWhereUniqueWithoutUsersInputObjectSchema as process_logsUpdateWithWhereUniqueWithoutUsersInputObjectSchema } from './process_logsUpdateWithWhereUniqueWithoutUsersInput.schema';
import { process_logsUpdateManyWithWhereWithoutUsersInputObjectSchema as process_logsUpdateManyWithWhereWithoutUsersInputObjectSchema } from './process_logsUpdateManyWithWhereWithoutUsersInput.schema';
...
const makeSchema = () => z.object({
  ...
  upsert: z.union([z.lazy(() => process_logsUpsertWithWhereUniqueWithoutUsersInputObjectSchema), z.lazy(() => process_logsUpsertWithWhereUniqueWithoutUsersInputObjectSchema).array()]).optional(),
  ...
  update: z.union([z.lazy(() => process_logsUpdateWithWhereUniqueWithoutUsersInputObjectSchema), z.lazy(() => process_logsUpdateWithWhereUniqueWithoutUsersInputObjectSchema).array()]).optional(),
  updateMany: z.union([z.lazy(() => process_logsUpdateManyWithWhereWithoutUsersInputObjectSchema), z.lazy(() => process_logsUpdateManyWithWhereWithoutUsersInputObjectSchema).array()]).optional(),
...
export const process_logsUncheckedUpdateManyWithoutUsersNestedInputObjectSchema: z.ZodType<Prisma.process_logsUncheckedUpdateManyWithoutUsersNestedInput> = makeSchema() as unknown as z.ZodType<Prisma.process_logsUncheckedUpdateManyWithoutUsersNestedInput>;
export const process_logsUncheckedUpdateManyWithoutUsersNestedInputObjectZodSchema = makeSchema();

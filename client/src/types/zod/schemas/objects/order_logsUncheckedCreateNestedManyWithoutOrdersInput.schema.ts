...
export const order_logsUncheckedCreateNestedManyWithoutOrdersInputObjectSchema: z.ZodType<Prisma.order_logsUncheckedCreateNestedManyWithoutOrdersInput> = makeSchema() as unknown as z.ZodType<Prisma.order_logsUncheckedCreateNestedManyWithoutOrdersInput>;
export const order_logsUncheckedCreateNestedManyWithoutOrdersInputObjectZodSchema = makeSchema();

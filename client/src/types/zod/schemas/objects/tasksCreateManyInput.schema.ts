...
export const tasksCreateManyInputObjectSchema: z.ZodType<Prisma.tasksCreateManyInput> = makeSchema() as unknown as z.ZodType<Prisma.tasksCreateManyInput>;
export const tasksCreateManyInputObjectZodSchema = makeSchema();

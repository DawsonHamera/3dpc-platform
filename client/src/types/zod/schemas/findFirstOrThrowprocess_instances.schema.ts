...
export const process_instancesFindFirstOrThrowSelectSchema: z.ZodType<Prisma.process_instancesSelect> = z.object({
...
export const process_instancesFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    process_template_id: z.boolean().optional(),
...
export const process_instancesFindFirstOrThrowSchema: z.ZodType<Prisma.process_instancesFindFirstOrThrowArgs> = z.object({ select: process_instancesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => process_instancesIncludeObjectSchema.optional()), orderBy: z.union([process_instancesOrderByWithRelationInputObjectSchema, process_instancesOrderByWithRelationInputObjectSchema.array()]).optional(), where: process_instancesWhereInputObjectSchema.optional(), cursor: process_instancesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProcessInstancesScalarFieldEnumSchema, ProcessInstancesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.process_instancesFindFirstOrThrowArgs>;

export const process_instancesFindFirstOrThrowZodSchema = z.object({ select: process_instancesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => process_instancesIncludeObjectSchema.optional()), orderBy: z.union([process_instancesOrderByWithRelationInputObjectSchema, process_instancesOrderByWithRelationInputObjectSchema.array()]).optional(), where: process_instancesWhereInputObjectSchema.optional(), cursor: process_instancesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProcessInstancesScalarFieldEnumSchema, ProcessInstancesScalarFieldEnumSchema.array()]).optional() }).strict();
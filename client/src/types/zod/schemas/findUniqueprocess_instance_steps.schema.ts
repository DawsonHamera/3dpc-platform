...
export const process_instance_stepsFindUniqueSchema: z.ZodType<Prisma.process_instance_stepsFindUniqueArgs> = z.object({ select: process_instance_stepsSelectObjectSchema.optional(), include: process_instance_stepsIncludeObjectSchema.optional(), where: process_instance_stepsWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.process_instance_stepsFindUniqueArgs>;

export const process_instance_stepsFindUniqueZodSchema = z.object({ select: process_instance_stepsSelectObjectSchema.optional(), include: process_instance_stepsIncludeObjectSchema.optional(), where: process_instance_stepsWhereUniqueInputObjectSchema }).strict();
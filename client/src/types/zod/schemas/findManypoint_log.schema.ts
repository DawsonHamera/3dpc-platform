...
export const point_logFindManySelectSchema: z.ZodType<Prisma.point_logSelect> = z.object({
...
export const point_logFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    change: z.boolean().optional(),
    reason: z.boolean().optional(),
...
export const point_logFindManySchema: z.ZodType<Prisma.point_logFindManyArgs> = z.object({ select: point_logFindManySelectSchema.optional(), include: z.lazy(() => point_logIncludeObjectSchema.optional()), orderBy: z.union([point_logOrderByWithRelationInputObjectSchema, point_logOrderByWithRelationInputObjectSchema.array()]).optional(), where: point_logWhereInputObjectSchema.optional(), cursor: point_logWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PointLogScalarFieldEnumSchema, PointLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.point_logFindManyArgs>;

export const point_logFindManyZodSchema = z.object({ select: point_logFindManySelectSchema.optional(), include: z.lazy(() => point_logIncludeObjectSchema.optional()), orderBy: z.union([point_logOrderByWithRelationInputObjectSchema, point_logOrderByWithRelationInputObjectSchema.array()]).optional(), where: point_logWhereInputObjectSchema.optional(), cursor: point_logWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PointLogScalarFieldEnumSchema, PointLogScalarFieldEnumSchema.array()]).optional() }).strict();
...
export const error_reportsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.error_reportsSelect> = z.object({
...
export const error_reportsFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    task_id: z.boolean().optional(),
    submitted_by: z.boolean().optional(),
    step_id: z.boolean().optional(),
...
export const error_reportsFindFirstOrThrowSchema: z.ZodType<Prisma.error_reportsFindFirstOrThrowArgs> = z.object({ select: error_reportsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => error_reportsIncludeObjectSchema.optional()), orderBy: z.union([error_reportsOrderByWithRelationInputObjectSchema, error_reportsOrderByWithRelationInputObjectSchema.array()]).optional(), where: error_reportsWhereInputObjectSchema.optional(), cursor: error_reportsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ErrorReportsScalarFieldEnumSchema, ErrorReportsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.error_reportsFindFirstOrThrowArgs>;

export const error_reportsFindFirstOrThrowZodSchema = z.object({ select: error_reportsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => error_reportsIncludeObjectSchema.optional()), orderBy: z.union([error_reportsOrderByWithRelationInputObjectSchema, error_reportsOrderByWithRelationInputObjectSchema.array()]).optional(), where: error_reportsWhereInputObjectSchema.optional(), cursor: error_reportsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ErrorReportsScalarFieldEnumSchema, ErrorReportsScalarFieldEnumSchema.array()]).optional() }).strict();
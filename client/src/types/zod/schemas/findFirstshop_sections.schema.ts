...
export const shop_sectionsFindFirstSelectSchema: z.ZodType<Prisma.shop_sectionsSelect> = z.object({
...
export const shop_sectionsFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    label: z.boolean().optional(),
    order_index: z.boolean().optional(),
...
export const shop_sectionsFindFirstSchema: z.ZodType<Prisma.shop_sectionsFindFirstArgs> = z.object({ select: shop_sectionsFindFirstSelectSchema.optional(), include: z.lazy(() => shop_sectionsIncludeObjectSchema.optional()), orderBy: z.union([shop_sectionsOrderByWithRelationInputObjectSchema, shop_sectionsOrderByWithRelationInputObjectSchema.array()]).optional(), where: shop_sectionsWhereInputObjectSchema.optional(), cursor: shop_sectionsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ShopSectionsScalarFieldEnumSchema, ShopSectionsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.shop_sectionsFindFirstArgs>;

export const shop_sectionsFindFirstZodSchema = z.object({ select: shop_sectionsFindFirstSelectSchema.optional(), include: z.lazy(() => shop_sectionsIncludeObjectSchema.optional()), orderBy: z.union([shop_sectionsOrderByWithRelationInputObjectSchema, shop_sectionsOrderByWithRelationInputObjectSchema.array()]).optional(), where: shop_sectionsWhereInputObjectSchema.optional(), cursor: shop_sectionsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ShopSectionsScalarFieldEnumSchema, ShopSectionsScalarFieldEnumSchema.array()]).optional() }).strict();
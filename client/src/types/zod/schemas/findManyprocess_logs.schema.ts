...
export const process_logsFindManySelectSchema: z.ZodType<Prisma.process_logsSelect> = z.object({
...
export const process_logsFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    process_instance_id: z.boolean().optional(),
    step_order: z.boolean().optional(),
    level: z.boolean().optional(),
...
export const process_logsFindManySchema: z.ZodType<Prisma.process_logsFindManyArgs> = z.object({ select: process_logsFindManySelectSchema.optional(), include: z.lazy(() => process_logsIncludeObjectSchema.optional()), orderBy: z.union([process_logsOrderByWithRelationInputObjectSchema, process_logsOrderByWithRelationInputObjectSchema.array()]).optional(), where: process_logsWhereInputObjectSchema.optional(), cursor: process_logsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProcessLogsScalarFieldEnumSchema, ProcessLogsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.process_logsFindManyArgs>;

export const process_logsFindManyZodSchema = z.object({ select: process_logsFindManySelectSchema.optional(), include: z.lazy(() => process_logsIncludeObjectSchema.optional()), orderBy: z.union([process_logsOrderByWithRelationInputObjectSchema, process_logsOrderByWithRelationInputObjectSchema.array()]).optional(), where: process_logsWhereInputObjectSchema.optional(), cursor: process_logsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProcessLogsScalarFieldEnumSchema, ProcessLogsScalarFieldEnumSchema.array()]).optional() }).strict();
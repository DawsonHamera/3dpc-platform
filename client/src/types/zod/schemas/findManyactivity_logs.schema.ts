...
export const activity_logsFindManySelectSchema: z.ZodType<Prisma.activity_logsSelect> = z.object({
...
export const activity_logsFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    action_type: z.boolean().optional(),
    table_name: z.boolean().optional(),
...
export const activity_logsFindManySchema: z.ZodType<Prisma.activity_logsFindManyArgs> = z.object({ select: activity_logsFindManySelectSchema.optional(), include: z.lazy(() => activity_logsIncludeObjectSchema.optional()), orderBy: z.union([activity_logsOrderByWithRelationInputObjectSchema, activity_logsOrderByWithRelationInputObjectSchema.array()]).optional(), where: activity_logsWhereInputObjectSchema.optional(), cursor: activity_logsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActivityLogsScalarFieldEnumSchema, ActivityLogsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.activity_logsFindManyArgs>;

export const activity_logsFindManyZodSchema = z.object({ select: activity_logsFindManySelectSchema.optional(), include: z.lazy(() => activity_logsIncludeObjectSchema.optional()), orderBy: z.union([activity_logsOrderByWithRelationInputObjectSchema, activity_logsOrderByWithRelationInputObjectSchema.array()]).optional(), where: activity_logsWhereInputObjectSchema.optional(), cursor: activity_logsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActivityLogsScalarFieldEnumSchema, ActivityLogsScalarFieldEnumSchema.array()]).optional() }).strict();
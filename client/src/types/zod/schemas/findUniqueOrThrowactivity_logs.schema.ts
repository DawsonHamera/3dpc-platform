...
export const activity_logsFindUniqueOrThrowSchema: z.ZodType<Prisma.activity_logsFindUniqueOrThrowArgs> = z.object({ select: activity_logsSelectObjectSchema.optional(), include: activity_logsIncludeObjectSchema.optional(), where: activity_logsWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.activity_logsFindUniqueOrThrowArgs>;

export const activity_logsFindUniqueOrThrowZodSchema = z.object({ select: activity_logsSelectObjectSchema.optional(), include: activity_logsIncludeObjectSchema.optional(), where: activity_logsWhereUniqueInputObjectSchema }).strict();
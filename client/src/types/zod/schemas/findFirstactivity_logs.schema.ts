...
export const activity_logsFindFirstSelectSchema: z.ZodType<Prisma.activity_logsSelect> = z.object({
...
export const activity_logsFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    action_type: z.boolean().optional(),
    table_name: z.boolean().optional(),
...
export const activity_logsFindFirstSchema: z.ZodType<Prisma.activity_logsFindFirstArgs> = z.object({ select: activity_logsFindFirstSelectSchema.optional(), include: z.lazy(() => activity_logsIncludeObjectSchema.optional()), orderBy: z.union([activity_logsOrderByWithRelationInputObjectSchema, activity_logsOrderByWithRelationInputObjectSchema.array()]).optional(), where: activity_logsWhereInputObjectSchema.optional(), cursor: activity_logsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActivityLogsScalarFieldEnumSchema, ActivityLogsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.activity_logsFindFirstArgs>;

export const activity_logsFindFirstZodSchema = z.object({ select: activity_logsFindFirstSelectSchema.optional(), include: z.lazy(() => activity_logsIncludeObjectSchema.optional()), orderBy: z.union([activity_logsOrderByWithRelationInputObjectSchema, activity_logsOrderByWithRelationInputObjectSchema.array()]).optional(), where: activity_logsWhereInputObjectSchema.optional(), cursor: activity_logsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActivityLogsScalarFieldEnumSchema, ActivityLogsScalarFieldEnumSchema.array()]).optional() }).strict();
...
export const activity_logFindManySelectSchema: z.ZodType<Prisma.activity_logSelect> = z.object({
...
export const activity_logFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    action_type: z.boolean().optional(),
    table_name: z.boolean().optional(),

...
export const step_actionsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.step_actionsSelect> = z.object({
...
export const step_actionsFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    step_id: z.boolean().optional(),
    action_order: z.boolean().optional(),
    label: z.boolean().optional(),
...
export const step_actionsFindFirstOrThrowSchema: z.ZodType<Prisma.step_actionsFindFirstOrThrowArgs> = z.object({ select: step_actionsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => step_actionsIncludeObjectSchema.optional()), orderBy: z.union([step_actionsOrderByWithRelationInputObjectSchema, step_actionsOrderByWithRelationInputObjectSchema.array()]).optional(), where: step_actionsWhereInputObjectSchema.optional(), cursor: step_actionsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StepActionsScalarFieldEnumSchema, StepActionsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.step_actionsFindFirstOrThrowArgs>;

export const step_actionsFindFirstOrThrowZodSchema = z.object({ select: step_actionsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => step_actionsIncludeObjectSchema.optional()), orderBy: z.union([step_actionsOrderByWithRelationInputObjectSchema, step_actionsOrderByWithRelationInputObjectSchema.array()]).optional(), where: step_actionsWhereInputObjectSchema.optional(), cursor: step_actionsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StepActionsScalarFieldEnumSchema, StepActionsScalarFieldEnumSchema.array()]).optional() }).strict();
...
export const product_variantsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.product_variantsSelect> = z.object({
...
export const product_variantsFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    material_id: z.boolean().optional(),
    name: z.boolean().optional(),
    image_file_id: z.boolean().optional(),
...
export const product_variantsFindFirstOrThrowSchema: z.ZodType<Prisma.product_variantsFindFirstOrThrowArgs> = z.object({ select: product_variantsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => product_variantsIncludeObjectSchema.optional()), orderBy: z.union([product_variantsOrderByWithRelationInputObjectSchema, product_variantsOrderByWithRelationInputObjectSchema.array()]).optional(), where: product_variantsWhereInputObjectSchema.optional(), cursor: product_variantsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductVariantsScalarFieldEnumSchema, ProductVariantsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.product_variantsFindFirstOrThrowArgs>;

export const product_variantsFindFirstOrThrowZodSchema = z.object({ select: product_variantsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => product_variantsIncludeObjectSchema.optional()), orderBy: z.union([product_variantsOrderByWithRelationInputObjectSchema, product_variantsOrderByWithRelationInputObjectSchema.array()]).optional(), where: product_variantsWhereInputObjectSchema.optional(), cursor: product_variantsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductVariantsScalarFieldEnumSchema, ProductVariantsScalarFieldEnumSchema.array()]).optional() }).strict();
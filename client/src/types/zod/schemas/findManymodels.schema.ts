...
export const modelsFindManySelectSchema: z.ZodType<Prisma.modelsSelect> = z.object({
...
export const modelsFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    image_file_id: z.boolean().optional(),
    model_file_id: z.boolean().optional(),
...
export const modelsFindManySchema: z.ZodType<Prisma.modelsFindManyArgs> = z.object({ select: modelsFindManySelectSchema.optional(), include: z.lazy(() => modelsIncludeObjectSchema.optional()), orderBy: z.union([modelsOrderByWithRelationInputObjectSchema, modelsOrderByWithRelationInputObjectSchema.array()]).optional(), where: modelsWhereInputObjectSchema.optional(), cursor: modelsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ModelsScalarFieldEnumSchema, ModelsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.modelsFindManyArgs>;

export const modelsFindManyZodSchema = z.object({ select: modelsFindManySelectSchema.optional(), include: z.lazy(() => modelsIncludeObjectSchema.optional()), orderBy: z.union([modelsOrderByWithRelationInputObjectSchema, modelsOrderByWithRelationInputObjectSchema.array()]).optional(), where: modelsWhereInputObjectSchema.optional(), cursor: modelsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ModelsScalarFieldEnumSchema, ModelsScalarFieldEnumSchema.array()]).optional() }).strict();
...
export const activity_logsFindUniqueSchema: z.ZodType<Prisma.activity_logsFindUniqueArgs> = z.object({ select: activity_logsSelectObjectSchema.optional(), include: activity_logsIncludeObjectSchema.optional(), where: activity_logsWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.activity_logsFindUniqueArgs>;

export const activity_logsFindUniqueZodSchema = z.object({ select: activity_logsSelectObjectSchema.optional(), include: activity_logsIncludeObjectSchema.optional(), where: activity_logsWhereUniqueInputObjectSchema }).strict();
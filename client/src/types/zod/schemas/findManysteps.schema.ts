...
export const stepsFindManySelectSchema: z.ZodType<Prisma.stepsSelect> = z.object({
...
export const stepsFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    title: z.boolean().optional(),
    description: z.boolean().optional(),
    is_critical: z.boolean().optional(),
...
export const stepsFindManySchema: z.ZodType<Prisma.stepsFindManyArgs> = z.object({ select: stepsFindManySelectSchema.optional(), include: z.lazy(() => stepsIncludeObjectSchema.optional()), orderBy: z.union([stepsOrderByWithRelationInputObjectSchema, stepsOrderByWithRelationInputObjectSchema.array()]).optional(), where: stepsWhereInputObjectSchema.optional(), cursor: stepsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StepsScalarFieldEnumSchema, StepsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.stepsFindManyArgs>;

export const stepsFindManyZodSchema = z.object({ select: stepsFindManySelectSchema.optional(), include: z.lazy(() => stepsIncludeObjectSchema.optional()), orderBy: z.union([stepsOrderByWithRelationInputObjectSchema, stepsOrderByWithRelationInputObjectSchema.array()]).optional(), where: stepsWhereInputObjectSchema.optional(), cursor: stepsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StepsScalarFieldEnumSchema, StepsScalarFieldEnumSchema.array()]).optional() }).strict();
...
export const printersFindFirstSelectSchema: z.ZodType<Prisma.printersSelect> = z.object({
...
export const printersFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    status_id: z.boolean().optional(),
    name: z.boolean().optional(),
    location: z.boolean().optional(),
...
export const printersFindFirstSchema: z.ZodType<Prisma.printersFindFirstArgs> = z.object({ select: printersFindFirstSelectSchema.optional(), include: z.lazy(() => printersIncludeObjectSchema.optional()), orderBy: z.union([printersOrderByWithRelationInputObjectSchema, printersOrderByWithRelationInputObjectSchema.array()]).optional(), where: printersWhereInputObjectSchema.optional(), cursor: printersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PrintersScalarFieldEnumSchema, PrintersScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.printersFindFirstArgs>;

export const printersFindFirstZodSchema = z.object({ select: printersFindFirstSelectSchema.optional(), include: z.lazy(() => printersIncludeObjectSchema.optional()), orderBy: z.union([printersOrderByWithRelationInputObjectSchema, printersOrderByWithRelationInputObjectSchema.array()]).optional(), where: printersWhereInputObjectSchema.optional(), cursor: printersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PrintersScalarFieldEnumSchema, PrintersScalarFieldEnumSchema.array()]).optional() }).strict();
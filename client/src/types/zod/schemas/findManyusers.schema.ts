...
export const usersFindManySelectSchema: z.ZodType<Prisma.usersSelect> = z.object({
...
export const usersFindManySchema: z.ZodType<Prisma.usersFindManyArgs> = z.object({ select: usersFindManySelectSchema.optional(), include: z.lazy(() => usersIncludeObjectSchema.optional()), orderBy: z.union([usersOrderByWithRelationInputObjectSchema, usersOrderByWithRelationInputObjectSchema.array()]).optional(), where: usersWhereInputObjectSchema.optional(), cursor: usersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsersScalarFieldEnumSchema, UsersScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.usersFindManyArgs>;

export const usersFindManyZodSchema = z.object({ select: usersFindManySelectSchema.optional(), include: z.lazy(() => usersIncludeObjectSchema.optional()), orderBy: z.union([usersOrderByWithRelationInputObjectSchema, usersOrderByWithRelationInputObjectSchema.array()]).optional(), where: usersWhereInputObjectSchema.optional(), cursor: usersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsersScalarFieldEnumSchema, UsersScalarFieldEnumSchema.array()]).optional() }).strict();
...
export const usersFindFirstOrThrowSelectSchema: z.ZodType<Prisma.usersSelect> = z.object({
...
export const usersFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    email: z.boolean().optional(),
    password_hash: z.boolean().optional(),
...
export const usersFindFirstOrThrowSchema: z.ZodType<Prisma.usersFindFirstOrThrowArgs> = z.object({ select: usersFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => usersIncludeObjectSchema.optional()), orderBy: z.union([usersOrderByWithRelationInputObjectSchema, usersOrderByWithRelationInputObjectSchema.array()]).optional(), where: usersWhereInputObjectSchema.optional(), cursor: usersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsersScalarFieldEnumSchema, UsersScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.usersFindFirstOrThrowArgs>;

export const usersFindFirstOrThrowZodSchema = z.object({ select: usersFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => usersIncludeObjectSchema.optional()), orderBy: z.union([usersOrderByWithRelationInputObjectSchema, usersOrderByWithRelationInputObjectSchema.array()]).optional(), where: usersWhereInputObjectSchema.optional(), cursor: usersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsersScalarFieldEnumSchema, UsersScalarFieldEnumSchema.array()]).optional() }).strict();
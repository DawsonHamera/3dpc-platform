...
export const printer_statusesFindManySelectSchema: z.ZodType<Prisma.printer_statusesSelect> = z.object({
...
export const printer_statusesFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    created_at: z.boolean().optional(),
...
export const printer_statusesFindManySchema: z.ZodType<Prisma.printer_statusesFindManyArgs> = z.object({ select: printer_statusesFindManySelectSchema.optional(), include: z.lazy(() => printer_statusesIncludeObjectSchema.optional()), orderBy: z.union([printer_statusesOrderByWithRelationInputObjectSchema, printer_statusesOrderByWithRelationInputObjectSchema.array()]).optional(), where: printer_statusesWhereInputObjectSchema.optional(), cursor: printer_statusesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PrinterStatusesScalarFieldEnumSchema, PrinterStatusesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.printer_statusesFindManyArgs>;

export const printer_statusesFindManyZodSchema = z.object({ select: printer_statusesFindManySelectSchema.optional(), include: z.lazy(() => printer_statusesIncludeObjectSchema.optional()), orderBy: z.union([printer_statusesOrderByWithRelationInputObjectSchema, printer_statusesOrderByWithRelationInputObjectSchema.array()]).optional(), where: printer_statusesWhereInputObjectSchema.optional(), cursor: printer_statusesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PrinterStatusesScalarFieldEnumSchema, PrinterStatusesScalarFieldEnumSchema.array()]).optional() }).strict();
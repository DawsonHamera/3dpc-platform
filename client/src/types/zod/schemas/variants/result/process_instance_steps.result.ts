...
// prettier-ignore
export const process_instance_stepsResultSchema = z.object({
    id: z.number().int(),
...
export type process_instance_stepsResultType = z.infer<typeof process_instance_stepsResultSchema>;

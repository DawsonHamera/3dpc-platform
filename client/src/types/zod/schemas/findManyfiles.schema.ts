...
export const filesFindManySelectSchema: z.ZodType<Prisma.filesSelect> = z.object({
...
export const filesFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    original_name: z.boolean().optional(),
    stored_name: z.boolean().optional(),
    mime_type: z.boolean().optional(),
...
export const filesFindManySchema: z.ZodType<Prisma.filesFindManyArgs> = z.object({ select: filesFindManySelectSchema.optional(), include: z.lazy(() => filesIncludeObjectSchema.optional()), orderBy: z.union([filesOrderByWithRelationInputObjectSchema, filesOrderByWithRelationInputObjectSchema.array()]).optional(), where: filesWhereInputObjectSchema.optional(), cursor: filesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FilesScalarFieldEnumSchema, FilesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.filesFindManyArgs>;

export const filesFindManyZodSchema = z.object({ select: filesFindManySelectSchema.optional(), include: z.lazy(() => filesIncludeObjectSchema.optional()), orderBy: z.union([filesOrderByWithRelationInputObjectSchema, filesOrderByWithRelationInputObjectSchema.array()]).optional(), where: filesWhereInputObjectSchema.optional(), cursor: filesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FilesScalarFieldEnumSchema, FilesScalarFieldEnumSchema.array()]).optional() }).strict();
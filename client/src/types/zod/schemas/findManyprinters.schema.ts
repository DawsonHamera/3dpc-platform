...
export const printersFindManySelectSchema: z.ZodType<Prisma.printersSelect> = z.object({
...
export const printersFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    status_id: z.boolean().optional(),
    name: z.boolean().optional(),
    location: z.boolean().optional(),
...
export const printersFindManySchema: z.ZodType<Prisma.printersFindManyArgs> = z.object({ select: printersFindManySelectSchema.optional(), include: z.lazy(() => printersIncludeObjectSchema.optional()), orderBy: z.union([printersOrderByWithRelationInputObjectSchema, printersOrderByWithRelationInputObjectSchema.array()]).optional(), where: printersWhereInputObjectSchema.optional(), cursor: printersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PrintersScalarFieldEnumSchema, PrintersScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.printersFindManyArgs>;

export const printersFindManyZodSchema = z.object({ select: printersFindManySelectSchema.optional(), include: z.lazy(() => printersIncludeObjectSchema.optional()), orderBy: z.union([printersOrderByWithRelationInputObjectSchema, printersOrderByWithRelationInputObjectSchema.array()]).optional(), where: printersWhereInputObjectSchema.optional(), cursor: printersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PrintersScalarFieldEnumSchema, PrintersScalarFieldEnumSchema.array()]).optional() }).strict();
...
export const shop_sectionsFindManySelectSchema: z.ZodType<Prisma.shop_sectionsSelect> = z.object({
...
export const shop_sectionsFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    label: z.boolean().optional(),
    order_index: z.boolean().optional(),
...
export const shop_sectionsFindManySchema: z.ZodType<Prisma.shop_sectionsFindManyArgs> = z.object({ select: shop_sectionsFindManySelectSchema.optional(), include: z.lazy(() => shop_sectionsIncludeObjectSchema.optional()), orderBy: z.union([shop_sectionsOrderByWithRelationInputObjectSchema, shop_sectionsOrderByWithRelationInputObjectSchema.array()]).optional(), where: shop_sectionsWhereInputObjectSchema.optional(), cursor: shop_sectionsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ShopSectionsScalarFieldEnumSchema, ShopSectionsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.shop_sectionsFindManyArgs>;

export const shop_sectionsFindManyZodSchema = z.object({ select: shop_sectionsFindManySelectSchema.optional(), include: z.lazy(() => shop_sectionsIncludeObjectSchema.optional()), orderBy: z.union([shop_sectionsOrderByWithRelationInputObjectSchema, shop_sectionsOrderByWithRelationInputObjectSchema.array()]).optional(), where: shop_sectionsWhereInputObjectSchema.optional(), cursor: shop_sectionsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ShopSectionsScalarFieldEnumSchema, ShopSectionsScalarFieldEnumSchema.array()]).optional() }).strict();
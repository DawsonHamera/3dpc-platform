...
export const stepsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.stepsSelect> = z.object({
...
export const stepsFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    title: z.boolean().optional(),
    description: z.boolean().optional(),
    is_critical: z.boolean().optional(),
...
export const stepsFindFirstOrThrowSchema: z.ZodType<Prisma.stepsFindFirstOrThrowArgs> = z.object({ select: stepsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => stepsIncludeObjectSchema.optional()), orderBy: z.union([stepsOrderByWithRelationInputObjectSchema, stepsOrderByWithRelationInputObjectSchema.array()]).optional(), where: stepsWhereInputObjectSchema.optional(), cursor: stepsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StepsScalarFieldEnumSchema, StepsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.stepsFindFirstOrThrowArgs>;

export const stepsFindFirstOrThrowZodSchema = z.object({ select: stepsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => stepsIncludeObjectSchema.optional()), orderBy: z.union([stepsOrderByWithRelationInputObjectSchema, stepsOrderByWithRelationInputObjectSchema.array()]).optional(), where: stepsWhereInputObjectSchema.optional(), cursor: stepsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StepsScalarFieldEnumSchema, StepsScalarFieldEnumSchema.array()]).optional() }).strict();
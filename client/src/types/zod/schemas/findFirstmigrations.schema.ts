...
export const migrationsFindFirstSelectSchema: z.ZodType<Prisma.migrationsSelect> = z.object({
...
export const migrationsFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    version: z.boolean().optional(),
    class: z.boolean().optional(),
    group: z.boolean().optional(),
...
export const migrationsFindFirstSchema: z.ZodType<Prisma.migrationsFindFirstArgs> = z.object({ select: migrationsFindFirstSelectSchema.optional(),  orderBy: z.union([migrationsOrderByWithRelationInputObjectSchema, migrationsOrderByWithRelationInputObjectSchema.array()]).optional(), where: migrationsWhereInputObjectSchema.optional(), cursor: migrationsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MigrationsScalarFieldEnumSchema, MigrationsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.migrationsFindFirstArgs>;

export const migrationsFindFirstZodSchema = z.object({ select: migrationsFindFirstSelectSchema.optional(),  orderBy: z.union([migrationsOrderByWithRelationInputObjectSchema, migrationsOrderByWithRelationInputObjectSchema.array()]).optional(), where: migrationsWhereInputObjectSchema.optional(), cursor: migrationsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MigrationsScalarFieldEnumSchema, MigrationsScalarFieldEnumSchema.array()]).optional() }).strict();
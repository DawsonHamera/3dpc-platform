...
export const step_contentFindFirstOrThrowSelectSchema: z.ZodType<Prisma.step_contentSelect> = z.object({
...
export const step_contentFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    step_id: z.boolean().optional(),
    content_order: z.boolean().optional(),
    content_type: z.boolean().optional(),
...
export const step_contentFindFirstOrThrowSchema: z.ZodType<Prisma.step_contentFindFirstOrThrowArgs> = z.object({ select: step_contentFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => step_contentIncludeObjectSchema.optional()), orderBy: z.union([step_contentOrderByWithRelationInputObjectSchema, step_contentOrderByWithRelationInputObjectSchema.array()]).optional(), where: step_contentWhereInputObjectSchema.optional(), cursor: step_contentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StepContentScalarFieldEnumSchema, StepContentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.step_contentFindFirstOrThrowArgs>;

export const step_contentFindFirstOrThrowZodSchema = z.object({ select: step_contentFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => step_contentIncludeObjectSchema.optional()), orderBy: z.union([step_contentOrderByWithRelationInputObjectSchema, step_contentOrderByWithRelationInputObjectSchema.array()]).optional(), where: step_contentWhereInputObjectSchema.optional(), cursor: step_contentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StepContentScalarFieldEnumSchema, StepContentScalarFieldEnumSchema.array()]).optional() }).strict();
...
export const recycling_logFindManySelectSchema: z.ZodType<Prisma.recycling_logSelect> = z.object({
...
export const recycling_logFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    type: z.boolean().optional(),
    amount: z.boolean().optional(),
    created_at: z.boolean().optional(),
...
export const recycling_logFindManySchema: z.ZodType<Prisma.recycling_logFindManyArgs> = z.object({ select: recycling_logFindManySelectSchema.optional(), include: z.lazy(() => recycling_logIncludeObjectSchema.optional()), orderBy: z.union([recycling_logOrderByWithRelationInputObjectSchema, recycling_logOrderByWithRelationInputObjectSchema.array()]).optional(), where: recycling_logWhereInputObjectSchema.optional(), cursor: recycling_logWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RecyclingLogScalarFieldEnumSchema, RecyclingLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.recycling_logFindManyArgs>;

export const recycling_logFindManyZodSchema = z.object({ select: recycling_logFindManySelectSchema.optional(), include: z.lazy(() => recycling_logIncludeObjectSchema.optional()), orderBy: z.union([recycling_logOrderByWithRelationInputObjectSchema, recycling_logOrderByWithRelationInputObjectSchema.array()]).optional(), where: recycling_logWhereInputObjectSchema.optional(), cursor: recycling_logWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RecyclingLogScalarFieldEnumSchema, RecyclingLogScalarFieldEnumSchema.array()]).optional() }).strict();
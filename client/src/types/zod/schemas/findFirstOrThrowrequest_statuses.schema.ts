...
export const request_statusesFindFirstOrThrowSelectSchema: z.ZodType<Prisma.request_statusesSelect> = z.object({
...
export const request_statusesFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    created_at: z.boolean().optional(),
...
export const request_statusesFindFirstOrThrowSchema: z.ZodType<Prisma.request_statusesFindFirstOrThrowArgs> = z.object({ select: request_statusesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => request_statusesIncludeObjectSchema.optional()), orderBy: z.union([request_statusesOrderByWithRelationInputObjectSchema, request_statusesOrderByWithRelationInputObjectSchema.array()]).optional(), where: request_statusesWhereInputObjectSchema.optional(), cursor: request_statusesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RequestStatusesScalarFieldEnumSchema, RequestStatusesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.request_statusesFindFirstOrThrowArgs>;

export const request_statusesFindFirstOrThrowZodSchema = z.object({ select: request_statusesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => request_statusesIncludeObjectSchema.optional()), orderBy: z.union([request_statusesOrderByWithRelationInputObjectSchema, request_statusesOrderByWithRelationInputObjectSchema.array()]).optional(), where: request_statusesWhereInputObjectSchema.optional(), cursor: request_statusesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RequestStatusesScalarFieldEnumSchema, RequestStatusesScalarFieldEnumSchema.array()]).optional() }).strict();
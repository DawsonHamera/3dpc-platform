...
export const step_contentFindFirstSelectSchema: z.ZodType<Prisma.step_contentSelect> = z.object({
...
export const step_contentFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    step_id: z.boolean().optional(),
    content_order: z.boolean().optional(),
    content_type: z.boolean().optional(),
...
export const step_contentFindFirstSchema: z.ZodType<Prisma.step_contentFindFirstArgs> = z.object({ select: step_contentFindFirstSelectSchema.optional(), include: z.lazy(() => step_contentIncludeObjectSchema.optional()), orderBy: z.union([step_contentOrderByWithRelationInputObjectSchema, step_contentOrderByWithRelationInputObjectSchema.array()]).optional(), where: step_contentWhereInputObjectSchema.optional(), cursor: step_contentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StepContentScalarFieldEnumSchema, StepContentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.step_contentFindFirstArgs>;

export const step_contentFindFirstZodSchema = z.object({ select: step_contentFindFirstSelectSchema.optional(), include: z.lazy(() => step_contentIncludeObjectSchema.optional()), orderBy: z.union([step_contentOrderByWithRelationInputObjectSchema, step_contentOrderByWithRelationInputObjectSchema.array()]).optional(), where: step_contentWhereInputObjectSchema.optional(), cursor: step_contentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StepContentScalarFieldEnumSchema, StepContentScalarFieldEnumSchema.array()]).optional() }).strict();
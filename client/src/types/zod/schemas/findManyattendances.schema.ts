...
export const attendancesFindManySelectSchema: z.ZodType<Prisma.attendancesSelect> = z.object({
...
export const attendancesFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    event_id: z.boolean().optional(),
    created_at: z.boolean().optional(),
...
export const attendancesFindManySchema: z.ZodType<Prisma.attendancesFindManyArgs> = z.object({ select: attendancesFindManySelectSchema.optional(), include: z.lazy(() => attendancesIncludeObjectSchema.optional()), orderBy: z.union([attendancesOrderByWithRelationInputObjectSchema, attendancesOrderByWithRelationInputObjectSchema.array()]).optional(), where: attendancesWhereInputObjectSchema.optional(), cursor: attendancesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AttendancesScalarFieldEnumSchema, AttendancesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.attendancesFindManyArgs>;

export const attendancesFindManyZodSchema = z.object({ select: attendancesFindManySelectSchema.optional(), include: z.lazy(() => attendancesIncludeObjectSchema.optional()), orderBy: z.union([attendancesOrderByWithRelationInputObjectSchema, attendancesOrderByWithRelationInputObjectSchema.array()]).optional(), where: attendancesWhereInputObjectSchema.optional(), cursor: attendancesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AttendancesScalarFieldEnumSchema, AttendancesScalarFieldEnumSchema.array()]).optional() }).strict();
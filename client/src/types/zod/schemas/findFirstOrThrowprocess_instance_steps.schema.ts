...
export const process_instance_stepsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.process_instance_stepsSelect> = z.object({
...
export const process_instance_stepsFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    process_instance_id: z.boolean().optional(),
    step_id: z.boolean().optional(),
    step_order: z.boolean().optional(),
...
export const process_instance_stepsFindFirstOrThrowSchema: z.ZodType<Prisma.process_instance_stepsFindFirstOrThrowArgs> = z.object({ select: process_instance_stepsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => process_instance_stepsIncludeObjectSchema.optional()), orderBy: z.union([process_instance_stepsOrderByWithRelationInputObjectSchema, process_instance_stepsOrderByWithRelationInputObjectSchema.array()]).optional(), where: process_instance_stepsWhereInputObjectSchema.optional(), cursor: process_instance_stepsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProcessInstanceStepsScalarFieldEnumSchema, ProcessInstanceStepsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.process_instance_stepsFindFirstOrThrowArgs>;

export const process_instance_stepsFindFirstOrThrowZodSchema = z.object({ select: process_instance_stepsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => process_instance_stepsIncludeObjectSchema.optional()), orderBy: z.union([process_instance_stepsOrderByWithRelationInputObjectSchema, process_instance_stepsOrderByWithRelationInputObjectSchema.array()]).optional(), where: process_instance_stepsWhereInputObjectSchema.optional(), cursor: process_instance_stepsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProcessInstanceStepsScalarFieldEnumSchema, ProcessInstanceStepsScalarFieldEnumSchema.array()]).optional() }).strict();
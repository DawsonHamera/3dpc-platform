...
export const point_logFindFirstSelectSchema: z.ZodType<Prisma.point_logSelect> = z.object({
...
export const point_logFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    change: z.boolean().optional(),
    reason: z.boolean().optional(),
...
export const point_logFindFirstSchema: z.ZodType<Prisma.point_logFindFirstArgs> = z.object({ select: point_logFindFirstSelectSchema.optional(), include: z.lazy(() => point_logIncludeObjectSchema.optional()), orderBy: z.union([point_logOrderByWithRelationInputObjectSchema, point_logOrderByWithRelationInputObjectSchema.array()]).optional(), where: point_logWhereInputObjectSchema.optional(), cursor: point_logWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PointLogScalarFieldEnumSchema, PointLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.point_logFindFirstArgs>;

export const point_logFindFirstZodSchema = z.object({ select: point_logFindFirstSelectSchema.optional(), include: z.lazy(() => point_logIncludeObjectSchema.optional()), orderBy: z.union([point_logOrderByWithRelationInputObjectSchema, point_logOrderByWithRelationInputObjectSchema.array()]).optional(), where: point_logWhereInputObjectSchema.optional(), cursor: point_logWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PointLogScalarFieldEnumSchema, PointLogScalarFieldEnumSchema.array()]).optional() }).strict();
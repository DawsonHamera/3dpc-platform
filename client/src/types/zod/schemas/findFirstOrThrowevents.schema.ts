...
export const eventsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.eventsSelect> = z.object({
...
export const eventsFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    title: z.boolean().optional(),
    description: z.boolean().optional(),
    location: z.boolean().optional(),
...
export const eventsFindFirstOrThrowSchema: z.ZodType<Prisma.eventsFindFirstOrThrowArgs> = z.object({ select: eventsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => eventsIncludeObjectSchema.optional()), orderBy: z.union([eventsOrderByWithRelationInputObjectSchema, eventsOrderByWithRelationInputObjectSchema.array()]).optional(), where: eventsWhereInputObjectSchema.optional(), cursor: eventsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EventsScalarFieldEnumSchema, EventsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.eventsFindFirstOrThrowArgs>;

export const eventsFindFirstOrThrowZodSchema = z.object({ select: eventsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => eventsIncludeObjectSchema.optional()), orderBy: z.union([eventsOrderByWithRelationInputObjectSchema, eventsOrderByWithRelationInputObjectSchema.array()]).optional(), where: eventsWhereInputObjectSchema.optional(), cursor: eventsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EventsScalarFieldEnumSchema, EventsScalarFieldEnumSchema.array()]).optional() }).strict();
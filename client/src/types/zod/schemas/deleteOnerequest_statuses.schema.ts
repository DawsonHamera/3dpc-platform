...
export const request_statusesDeleteOneSchema: z.ZodType<Prisma.request_statusesDeleteArgs> = z.object({ select: request_statusesSelectObjectSchema.optional(), include: request_statusesIncludeObjectSchema.optional(), where: request_statusesWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.request_statusesDeleteArgs>;

export const request_statusesDeleteOneZodSchema = z.object({ select: request_statusesSelectObjectSchema.optional(), include: request_statusesIncludeObjectSchema.optional(), where: request_statusesWhereUniqueInputObjectSchema }).strict();
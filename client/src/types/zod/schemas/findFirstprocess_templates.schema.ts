...
export const process_templatesFindFirstSelectSchema: z.ZodType<Prisma.process_templatesSelect> = z.object({
...
export const process_templatesFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    version: z.boolean().optional(),
...
export const process_templatesFindFirstSchema: z.ZodType<Prisma.process_templatesFindFirstArgs> = z.object({ select: process_templatesFindFirstSelectSchema.optional(), include: z.lazy(() => process_templatesIncludeObjectSchema.optional()), orderBy: z.union([process_templatesOrderByWithRelationInputObjectSchema, process_templatesOrderByWithRelationInputObjectSchema.array()]).optional(), where: process_templatesWhereInputObjectSchema.optional(), cursor: process_templatesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProcessTemplatesScalarFieldEnumSchema, ProcessTemplatesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.process_templatesFindFirstArgs>;

export const process_templatesFindFirstZodSchema = z.object({ select: process_templatesFindFirstSelectSchema.optional(), include: z.lazy(() => process_templatesIncludeObjectSchema.optional()), orderBy: z.union([process_templatesOrderByWithRelationInputObjectSchema, process_templatesOrderByWithRelationInputObjectSchema.array()]).optional(), where: process_templatesWhereInputObjectSchema.optional(), cursor: process_templatesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProcessTemplatesScalarFieldEnumSchema, ProcessTemplatesScalarFieldEnumSchema.array()]).optional() }).strict();
...
export const filesFindFirstSelectSchema: z.ZodType<Prisma.filesSelect> = z.object({
...
export const filesFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    original_name: z.boolean().optional(),
    stored_name: z.boolean().optional(),
    mime_type: z.boolean().optional(),

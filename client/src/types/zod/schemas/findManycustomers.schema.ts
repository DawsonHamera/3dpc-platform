...
export const customersFindManySchema: z.ZodType<Prisma.customersFindManyArgs> = z.object({ select: customersFindManySelectSchema.optional(),  orderBy: z.union([customersOrderByWithRelationInputObjectSchema, customersOrderByWithRelationInputObjectSchema.array()]).optional(), where: customersWhereInputObjectSchema.optional(), cursor: customersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CustomersScalarFieldEnumSchema, CustomersScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.customersFindManyArgs>;

export const customersFindManyZodSchema = z.object({ select: customersFindManySelectSchema.optional(),  orderBy: z.union([customersOrderByWithRelationInputObjectSchema, customersOrderByWithRelationInputObjectSchema.array()]).optional(), where: customersWhereInputObjectSchema.optional(), cursor: customersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CustomersScalarFieldEnumSchema, CustomersScalarFieldEnumSchema.array()]).optional() }).strict();
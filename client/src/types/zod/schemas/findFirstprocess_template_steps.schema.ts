...
export const process_template_stepsFindFirstSelectSchema: z.ZodType<Prisma.process_template_stepsSelect> = z.object({
...
export const process_template_stepsFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    process_template_id: z.boolean().optional(),
    step_id: z.boolean().optional(),
    step_order: z.boolean().optional(),
...
export const process_template_stepsFindFirstSchema: z.ZodType<Prisma.process_template_stepsFindFirstArgs> = z.object({ select: process_template_stepsFindFirstSelectSchema.optional(), include: z.lazy(() => process_template_stepsIncludeObjectSchema.optional()), orderBy: z.union([process_template_stepsOrderByWithRelationInputObjectSchema, process_template_stepsOrderByWithRelationInputObjectSchema.array()]).optional(), where: process_template_stepsWhereInputObjectSchema.optional(), cursor: process_template_stepsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProcessTemplateStepsScalarFieldEnumSchema, ProcessTemplateStepsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.process_template_stepsFindFirstArgs>;

export const process_template_stepsFindFirstZodSchema = z.object({ select: process_template_stepsFindFirstSelectSchema.optional(), include: z.lazy(() => process_template_stepsIncludeObjectSchema.optional()), orderBy: z.union([process_template_stepsOrderByWithRelationInputObjectSchema, process_template_stepsOrderByWithRelationInputObjectSchema.array()]).optional(), where: process_template_stepsWhereInputObjectSchema.optional(), cursor: process_template_stepsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProcessTemplateStepsScalarFieldEnumSchema, ProcessTemplateStepsScalarFieldEnumSchema.array()]).optional() }).strict();
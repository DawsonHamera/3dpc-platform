...
export const task_statusesFindManySelectSchema: z.ZodType<Prisma.task_statusesSelect> = z.object({
...
export const task_statusesFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    created_at: z.boolean().optional(),
...
export const task_statusesFindManySchema: z.ZodType<Prisma.task_statusesFindManyArgs> = z.object({ select: task_statusesFindManySelectSchema.optional(), include: z.lazy(() => task_statusesIncludeObjectSchema.optional()), orderBy: z.union([task_statusesOrderByWithRelationInputObjectSchema, task_statusesOrderByWithRelationInputObjectSchema.array()]).optional(), where: task_statusesWhereInputObjectSchema.optional(), cursor: task_statusesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskStatusesScalarFieldEnumSchema, TaskStatusesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.task_statusesFindManyArgs>;

export const task_statusesFindManyZodSchema = z.object({ select: task_statusesFindManySelectSchema.optional(), include: z.lazy(() => task_statusesIncludeObjectSchema.optional()), orderBy: z.union([task_statusesOrderByWithRelationInputObjectSchema, task_statusesOrderByWithRelationInputObjectSchema.array()]).optional(), where: task_statusesWhereInputObjectSchema.optional(), cursor: task_statusesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaskStatusesScalarFieldEnumSchema, TaskStatusesScalarFieldEnumSchema.array()]).optional() }).strict();
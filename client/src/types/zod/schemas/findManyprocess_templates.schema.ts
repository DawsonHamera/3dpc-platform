...
export const process_templatesFindManySelectSchema: z.ZodType<Prisma.process_templatesSelect> = z.object({
...
export const process_templatesFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    version: z.boolean().optional(),
...
export const process_templatesFindManySchema: z.ZodType<Prisma.process_templatesFindManyArgs> = z.object({ select: process_templatesFindManySelectSchema.optional(), include: z.lazy(() => process_templatesIncludeObjectSchema.optional()), orderBy: z.union([process_templatesOrderByWithRelationInputObjectSchema, process_templatesOrderByWithRelationInputObjectSchema.array()]).optional(), where: process_templatesWhereInputObjectSchema.optional(), cursor: process_templatesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProcessTemplatesScalarFieldEnumSchema, ProcessTemplatesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.process_templatesFindManyArgs>;

export const process_templatesFindManyZodSchema = z.object({ select: process_templatesFindManySelectSchema.optional(), include: z.lazy(() => process_templatesIncludeObjectSchema.optional()), orderBy: z.union([process_templatesOrderByWithRelationInputObjectSchema, process_templatesOrderByWithRelationInputObjectSchema.array()]).optional(), where: process_templatesWhereInputObjectSchema.optional(), cursor: process_templatesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProcessTemplatesScalarFieldEnumSchema, ProcessTemplatesScalarFieldEnumSchema.array()]).optional() }).strict();
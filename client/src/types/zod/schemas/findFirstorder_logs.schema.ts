...
export const order_logsFindFirstSelectSchema: z.ZodType<Prisma.order_logsSelect> = z.object({
...
export const order_logsFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    order_id: z.boolean().optional(),
    log_timestamp: z.boolean().optional(),
    log_message: z.boolean().optional(),
...
export const order_logsFindFirstSchema: z.ZodType<Prisma.order_logsFindFirstArgs> = z.object({ select: order_logsFindFirstSelectSchema.optional(), include: z.lazy(() => order_logsIncludeObjectSchema.optional()), orderBy: z.union([order_logsOrderByWithRelationInputObjectSchema, order_logsOrderByWithRelationInputObjectSchema.array()]).optional(), where: order_logsWhereInputObjectSchema.optional(), cursor: order_logsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OrderLogsScalarFieldEnumSchema, OrderLogsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.order_logsFindFirstArgs>;

export const order_logsFindFirstZodSchema = z.object({ select: order_logsFindFirstSelectSchema.optional(), include: z.lazy(() => order_logsIncludeObjectSchema.optional()), orderBy: z.union([order_logsOrderByWithRelationInputObjectSchema, order_logsOrderByWithRelationInputObjectSchema.array()]).optional(), where: order_logsWhereInputObjectSchema.optional(), cursor: order_logsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OrderLogsScalarFieldEnumSchema, OrderLogsScalarFieldEnumSchema.array()]).optional() }).strict();
...
export const activity_logFindFirstOrThrowSelectSchema: z.ZodType<Prisma.activity_logSelect> = z.object({
...
export const activity_logFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    user_id: z.boolean().optional(),
    action_type: z.boolean().optional(),
    table_name: z.boolean().optional(),
...
export const activity_logFindFirstOrThrowSchema: z.ZodType<Prisma.activity_logFindFirstOrThrowArgs> = z.object({ select: activity_logFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => activity_logIncludeObjectSchema.optional()), orderBy: z.union([activity_logOrderByWithRelationInputObjectSchema, activity_logOrderByWithRelationInputObjectSchema.array()]).optional(), where: activity_logWhereInputObjectSchema.optional(), cursor: activity_logWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActivityLogScalarFieldEnumSchema, ActivityLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.activity_logFindFirstOrThrowArgs>;

export const activity_logFindFirstOrThrowZodSchema = z.object({ select: activity_logFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => activity_logIncludeObjectSchema.optional()), orderBy: z.union([activity_logOrderByWithRelationInputObjectSchema, activity_logOrderByWithRelationInputObjectSchema.array()]).optional(), where: activity_logWhereInputObjectSchema.optional(), cursor: activity_logWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActivityLogScalarFieldEnumSchema, ActivityLogScalarFieldEnumSchema.array()]).optional() }).strict();
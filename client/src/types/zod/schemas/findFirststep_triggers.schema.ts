...
export const step_triggersFindFirstSelectSchema: z.ZodType<Prisma.step_triggersSelect> = z.object({
...
export const step_triggersFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    step_action_id: z.boolean().optional(),
    trigger_order: z.boolean().optional(),
    trigger_type: z.boolean().optional(),
...
export const step_triggersFindFirstSchema: z.ZodType<Prisma.step_triggersFindFirstArgs> = z.object({ select: step_triggersFindFirstSelectSchema.optional(), include: z.lazy(() => step_triggersIncludeObjectSchema.optional()), orderBy: z.union([step_triggersOrderByWithRelationInputObjectSchema, step_triggersOrderByWithRelationInputObjectSchema.array()]).optional(), where: step_triggersWhereInputObjectSchema.optional(), cursor: step_triggersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StepTriggersScalarFieldEnumSchema, StepTriggersScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.step_triggersFindFirstArgs>;

export const step_triggersFindFirstZodSchema = z.object({ select: step_triggersFindFirstSelectSchema.optional(), include: z.lazy(() => step_triggersIncludeObjectSchema.optional()), orderBy: z.union([step_triggersOrderByWithRelationInputObjectSchema, step_triggersOrderByWithRelationInputObjectSchema.array()]).optional(), where: step_triggersWhereInputObjectSchema.optional(), cursor: step_triggersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StepTriggersScalarFieldEnumSchema, StepTriggersScalarFieldEnumSchema.array()]).optional() }).strict();
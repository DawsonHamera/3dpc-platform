...
export const order_itemsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.order_itemsSelect> = z.object({
...
export const order_itemsFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    order_id: z.boolean().optional(),
    product_id: z.boolean().optional(),
    quantity: z.boolean().optional(),
...
export const order_itemsFindFirstOrThrowSchema: z.ZodType<Prisma.order_itemsFindFirstOrThrowArgs> = z.object({ select: order_itemsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => order_itemsIncludeObjectSchema.optional()), orderBy: z.union([order_itemsOrderByWithRelationInputObjectSchema, order_itemsOrderByWithRelationInputObjectSchema.array()]).optional(), where: order_itemsWhereInputObjectSchema.optional(), cursor: order_itemsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OrderItemsScalarFieldEnumSchema, OrderItemsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.order_itemsFindFirstOrThrowArgs>;

export const order_itemsFindFirstOrThrowZodSchema = z.object({ select: order_itemsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => order_itemsIncludeObjectSchema.optional()), orderBy: z.union([order_itemsOrderByWithRelationInputObjectSchema, order_itemsOrderByWithRelationInputObjectSchema.array()]).optional(), where: order_itemsWhereInputObjectSchema.optional(), cursor: order_itemsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OrderItemsScalarFieldEnumSchema, OrderItemsScalarFieldEnumSchema.array()]).optional() }).strict();
...
export const process_instancesFindUniqueSchema: z.ZodType<Prisma.process_instancesFindUniqueArgs> = z.object({ select: process_instancesSelectObjectSchema.optional(), include: process_instancesIncludeObjectSchema.optional(), where: process_instancesWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.process_instancesFindUniqueArgs>;

export const process_instancesFindUniqueZodSchema = z.object({ select: process_instancesSelectObjectSchema.optional(), include: process_instancesIncludeObjectSchema.optional(), where: process_instancesWhereUniqueInputObjectSchema }).strict();
...
export const tasksFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tasksSelect> = z.object({
...
export const tasksFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    request_id: z.boolean().optional(),
    model_id: z.boolean().optional(),
    printer_id: z.boolean().optional(),
...
export const tasksFindFirstOrThrowSchema: z.ZodType<Prisma.tasksFindFirstOrThrowArgs> = z.object({ select: tasksFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tasksIncludeObjectSchema.optional()), orderBy: z.union([tasksOrderByWithRelationInputObjectSchema, tasksOrderByWithRelationInputObjectSchema.array()]).optional(), where: tasksWhereInputObjectSchema.optional(), cursor: tasksWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TasksScalarFieldEnumSchema, TasksScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tasksFindFirstOrThrowArgs>;

export const tasksFindFirstOrThrowZodSchema = z.object({ select: tasksFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tasksIncludeObjectSchema.optional()), orderBy: z.union([tasksOrderByWithRelationInputObjectSchema, tasksOrderByWithRelationInputObjectSchema.array()]).optional(), where: tasksWhereInputObjectSchema.optional(), cursor: tasksWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TasksScalarFieldEnumSchema, TasksScalarFieldEnumSchema.array()]).optional() }).strict();
...
import { IonPage, IonContent, IonLabel, useIonRouter, IonIcon, IonLoading } from '@ionic/react';
...
import { LeaderboardWidget, TipsWidget } from './widgets/ScoreWidget';
...
const HomePage: React.FC = () => {
  ...
  useLayoutEffect(() => {
    ...
    return () => {
      ...
      if (contentRef.current && scrollListener) {
        contentRef.current.removeEventListener('ionScroll', scrollListener);
  ...
  {!isHeroVisible && <Header title="Home" />}
      ...
      >
        ...
        >
          <div ref={printerCarouselRef} style={{ width: '100%', height: '100%', willChange: 'transform' }}>
           {chosenEvent()}
          </div>
              ...
              <Card>
                <IonLabel>
                  <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <IonIcon icon={warningOutline} style={{ marginRight: 10 }} />
                    <p>The user dashboard is still in development</p>
                  </div>
                  <p style={{ padding: 20 }}>
                    If you have questions or ideas concerning the development of our club app,
                    please contact us at <i>hamerad27@puhsd.k12.ca.us</i> or <i>frankb27@puhsd.k12.ca.us</i>
                  </p>
                </IonLabel>
              </Card>
            </div>
